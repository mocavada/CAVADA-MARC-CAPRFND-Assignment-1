# C# Assignment Menu: CAPRFND Assignment 1

This C# console application provides an interactive menu to execute programming fundamentals exercises (Q1–Q7).

---

## **Program Structure**

- Main Menu: Select which question (1–7) to run.
- Each question is implemented as a separate static method.
- Q7 includes exception handling (`try..catch`) for input validation.
